...
// ---------------------------------------------------------------------------
// Inner component — remounted via key when sheet opens, resetting state naturally
// ---------------------------------------------------------------------------

function ValueSplitSheetContent({
  onClose,
  grandTotal,
  tableId,
  onProceed,
}: Omit<ValueSplitSheetProps, 'open'>) {
