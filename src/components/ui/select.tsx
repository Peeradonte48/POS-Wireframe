...
import { AltArrowDownLinear, CheckCircleLinear, AltArrowUpLinear } from "solar-icon-set"
  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon
        render={
          <AltArrowDownLinear size={16} className="pointer-events-none text-muted-foreground" />
        }
      />
    </SelectPrimitive.Trigger>
  )
...
function SelectItem({
  ...
  return (
    ...
    >
      ...
      >
        <CheckCircleLinear size={16} className="pointer-events-none" />
      </SelectPrimitive.ItemIndicator>
    </SelectPrimitive.Item>
  )
}
