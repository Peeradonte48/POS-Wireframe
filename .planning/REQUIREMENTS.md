...
- [ ] **TOKEN-01**: `--primary` chroma increased and gamut-verified for bold crimson
- [ ] **TOKEN-02**: Semantic status tokens (`--color-status-*`) defined for all 5 table states
- [ ] **TOKEN-03**: Elevation tokens (`--shadow-card`, `--shadow-panel`) defined for 3-tier depth
- [ ] **TOKEN-04**: Hardcoded Tailwind palette classes in TableTile, KdsTicketCard, AppSidebar replaced with token references

### Component Polish

- [ ] **COMP-01**: All primary action buttons are 44px with crimson glow and active press scale
- [ ] **COMP-02**: Table status indicators display as filled colored pill chips
