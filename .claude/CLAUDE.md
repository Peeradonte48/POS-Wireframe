...
Use as blueprint for design POS system
## ระยะ Pre-Dining (การจัดการคิวและโต๊ะ)
...
## ระยะ Ordering (การสั่งอาหารผ่านใบข้อสอบ)
...
พนักงาน (บน POS): กดยืนยันออเดอร์ ระบบจะทำการ ตัดสต็อกวัตถุดิบอัตโนมัติ และส่งรายการคำสั่งซื้อเข้าสู่ครัวทันที

## ระยะ Receiving (การรับอาหารและการบริการ)
...
## ระยะ Payment (การชำระเงินแบบเบ็ดเสร็จ)
...
## ระยะ Loyalty (การสะสมแต้มสมาชิก)
### แบบที่ 1: ไม่มีระบบ CRM (Standalone / Manual Loyalty)
...
### แบบที่ 2: มีระบบ CRM (Integrated CRM / Smart Loyalty)
